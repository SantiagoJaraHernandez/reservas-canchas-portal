  ...
  return (
    <header className="w-full bg-white shadow-card h-15">
      <div className="h-full max-w-7xl m-auto flex justify-between items-center px-4">
        ...
        <nav
          className={`bg-primaryDeg flex flex-col justify-evenly items-center absolute right-3 top-15 w-50 h-62.5 shadow-card rounded-card transition-all duration-300
